...
def enr_and_score_genes(adata, genelist_use,genelist_references,plots_title,gene_set="GO_Biological_Process_2021",overlap_threshold=0.6 ):
    #enr=gp.enrichr(gene_list=genelist_use,gene_sets=genelist_references[gene_set], organism="human")
    # changed this because for some reason the geneset I was downloading was different from the one on the web server causing issues later in the script
